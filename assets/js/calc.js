document
								...
								function calculateCalories(e) {
								  ...
								  if (
									...
									totalCalories.value =
                                    ((20.35/22.5)*parseFloat(age.value));
									...
									totalCalories.value =
                                    ((20.35/28.5)*parseFloat(age.value));
									...
									totalCalories.value =
                                    ((20.35/21)*parseFloat(age.value));


                                } else if (activity === "11") {
									totalCalories.value =
                                    ((20.35/15)*parseFloat(age.value));
									...
									totalCalories.value =
                                    ((20.35/15.4)*parseFloat(age.value));

                                } else if (activity === "15") {
									totalCalories.value =
                                    ((20.35/14)*parseFloat(age.value));
                                ...
                                ((20.35/25)*parseFloat(age.value));
                                    ...
                                    ((20.35/27)*parseFloat(age.value));
                                                                    ...
                                                                    totalCalories.value =
                                                                    ((20.35/72)*parseFloat(age.value));
                                                                } else if (activity === "70") {
                                                                    totalCalories.value =
                                                                    ((20.35/28)*parseFloat(age.value));
                                                                } else if (activity === "71") {
                                                                    totalCalories.value =
                                                                    ((20.35/38)*parseFloat(age.value));
                                                                } else if (activity === "72") {
                                                                    totalCalories.value =
                                                                    ((20.35/32)*parseFloat(age.value));
                                                                }
									...
									totalCalories.value =
                                    ((20.35/116)*parseFloat(age.value));
                                } else if (activity === "94") {
									totalCalories.value =
                                    ((20.35/30)*parseFloat(age.value));
